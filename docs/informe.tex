...
Queda pendiente, antes de la exposición, abrir en IntelliJ los archivos
\texttt{Estanque.java}, \texttt{Grameo.java}, \texttt{Empleado.java} y
\texttt{SobrecargaSiembra.java}, y repetir sobre ellos la misma inspección ya
hecha con \texttt{Siembra.java} y \texttt{AlertaCrecimiento.java}.
...
\begin{tabularx}{\linewidth}{lX}
\toprule
\textbf{Integrante} & \textbf{URL(s) de commit(s) en GitHub} \\
\midrule
Amagua Sacon Robyn Willian & PENDIENTE \\
Crespo Espinoza Kleber Obed & PENDIENTE \\
Rizzo Velez Edson Nagib & PENDIENTE \\
\bottomrule
\end{tabularx}
\end{center}
